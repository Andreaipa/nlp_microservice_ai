...
description: Qué se encontró al empezar y qué implicaba.
---
...
> El contenido real del dataset está en [DATASET.md](/datos/dataset/).
>
...
[PROTOCOLO_CAPTURA.md](/datos/protocolo-captura/) respetando esa numeración.
